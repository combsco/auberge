defmodule Auberge.RoomRate do
  ...
  schema "room_rates" do
    ...
    field :code, :string              # Unused
    field :type, :string              # Unused
    field :starts_at, Ecto.DateTime   # 2016-02-01
    field :ends_at, Ecto.DateTime     # 9999-02-01
  ...
  @required_params ~w(description starts_at ends_at days_of_week min_stay max_stay min_occupancy max_occupancy price)
  @optional_params ~w(code type extra_adult_price extra_child_price)
